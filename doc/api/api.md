...
+ Functions
  ...
  + [getEntry()](#the-scene-mixins-function-get-entry)
  ...
  + [injectClassMethods(Class)](#the-scene-mixins-function-inject-class-methods)
...
<a class='md-heading-link' name="the-scene-mixins-function-inject-class-methods" ></a>

### injectClassMethods(Class) -> `function`
